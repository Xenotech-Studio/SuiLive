...
{
    public RectTransform EnterRoomTemplate;
    ...
    private void Awake()
    {
        EnterRoomTemplate.gameObject.SetActive(false);
    }
    ...
    {
        if (EnterRoomManager.CheckCoolDown(er.uid, ConfigManager.Config.EnterRoomDrop.DropCoolDown))
        {
